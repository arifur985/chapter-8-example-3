...
This example contains an automated continous delivery done pipeline that builds and deploys the microservice to Kubernetes when code is pushed to the repository.
